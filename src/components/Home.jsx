  ...
  return (
    <div name="home" className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h1 className='text-4xl sm:text-7xl font-bold text-emerald-300 py-2'>Rohit James</h1>
            <h2 className='text-4xl sm:text-7xl font-bold text-emerald-500'>I'm a Full Stack Developer.</h2>
